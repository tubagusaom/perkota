        ...
        <form id="myform">
            <table class="table-data">
              <tr>
                  ...
                  <td>
                      : <?php echo form_dropdown('id_menu', $menu, $data->id_menu, 'id="id_menu" class="easyui-combobox" style="width: 250px;" data-options="required: true"'); ?>
                  </td>
              </tr>
                <tr>
                    <td style="width: 100px;text-align:left;">Kategori</td>
                    <td>
                         : <input id="kategori" name="kategori" style="width: 250px;" class="easyui-textbox" data-options="required: true" value="<?=$data->kategori?>">
                    </td>
                </tr>
                <tr>
