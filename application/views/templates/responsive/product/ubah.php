...
<form action="<?= base_url() . 'product/ubah_proses' ?>" method="post">
    ...
    <div class="content top-30 bottom-50">
        ...
        <div class="input-simple-1 has-icon input-green bottom-30 left-15">
            ...
            <i class="fa fa-newspaper"></i><input type="text" value="<?= $produk->nama_product ?>" id="nama_product" name="nama_product" placeholder="Nama Produk" required>
        </div>
...
- Model simple
- Nyaman Digunakan"><?= $produk->ket_product ?></textarea>
        </div>
        ...
        <div class="input-simple-1 has-icon input-green bottom-30 left-15">
                ...
                <div id="menu-success" class="content menu-flyin bg-blue-dark notification-large">
                    ...
                    <ol style="color:whitesmoke;font-weight:bold;">
                        ...
                        <li>
                            ...
                            < iframe width="560" height="315" <br> src="<font style="background:#000;">https://www.youtube.com/embed/7ONfxObUIOU</font>" title="YouTube video player" frameborder="0"><br>
                                < /iframe>
                        </li>
                    </ol>
                    </p>
            ...
            <input type="text" value="<?= $produk->link_product ?>" id="link_product" name="link_product" placeholder="Masukan URL Youtube">
        </div>
        ...
        <div class="input-simple-1 has-icon input-green bottom-10 left-15">
            ...
            <input type="number" value="<?= $produk->harga_product ?>" id="harga_product" name="harga_product" placeholder="Harga Barang" required>
        </div>

        <div class="input-simple-1 has-icon input-green bottom-30 left-15">
            <strong>Wajib</strong><em><b>Berat Produk</b> (Kilogram)</em>
            <i class="fa fa-sort-numeric-asc"></i>
            <input type="number" value="<?= $produk->berat_product ?>" id="berat_product" name="berat_product" placeholder="Berat Barang" required>
        </div>
        ...
        <div class="input-simple-1 has-icon input-green left-15">
            ...
            <i class="fa fa-sort-numeric-asc"></i>
            <input type="number" value="<?= $produk->jumlah_product ?>" id="jumlah_product" name="jumlah_product" placeholder="Stok Barang" required>
        </div>

        <div class="input-simple-1 has-icon input-green left-15">
            <strong>Wajib</strong><em><b>Minimum Pemesanan</b></em>
            <i class="fa fa-sort-numeric-asc"></i>
            <input type="number" value="<?= $produk->min_pesan_product ?>" id="" name="min_pesan_product" placeholder="Minimum Pemesanan" required>
        </div>

        <div class="input-simple-1 has-icon input-green bottom-30 left-15">
            <em><b>Tag Produk</b> (Pisahkan dengan tanda , (koma) )</em>
            <i class="fa fa-slack"></i>
            <input type="text" value="<?= $produk->tag_product ?>" id="tag_product" name="tag_product" placeholder="Hastag Product">
        </div>
    ...
    <div class="content demo-buttons">
        <button type="submit" name="button" class="button button-full button-round button-blue" style="cursor:pointer;">
            <i class="fa fa-plus"></i> Update Produk
        </button>
    </div>
