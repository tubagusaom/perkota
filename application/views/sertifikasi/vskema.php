                                      ...
                                      foreach($data as $key=>$value){?>
                                        <tr >
                                          <td align="center" style="text-align: center;">
                                            <a href="<?=base_url().'sertifikasi/vskema_detail/'.$value->id?>" class="btn btn-default btn-xs"><em class="fa fa-search"></em></a>

                                          </td>
                                          <td><a href="<?=base_url().'sertifikasi/vskema_detail/'.$value->id?>" ><?=$value->skema?></a></td>
                                          <td style="text-align:center;"><?=$value->jumlah_unit?></td>
