...
switch ($extension) {
    case "pdf":
        echo '<object type="application/pdf" data="' . base_url('assets/img/member/' . $nmfile) . '" width="100%" height="600" style="height: 85vh;">File Not Found / File No Support</object>';
        die();
        break;
    default:
        ?>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        var CanvasCrop = $.CanvasCrop({
            cropBox: ".imageBox",
            imgSrc: base_url + "assets/img/member/" + $("#idImg").val(),
            limitOver: 2
        });
        ...
        $("#crop").on("click", function () {
            ...
            $(".btnSelect").linkbutton({
                onClick: function () {
                    ...
                    $.post(base_url + "member/upload", dt, function (hsl) {
                        hsl = JSON.parse(hsl);
