    ...
    <page_header>
        <table style="width: 100%; border: 0px;">
            <tr>
                ...
                <td style="text-align: left;    width: 34%;font-weight: lighter;">Lembaga Sertifikasi Profesi<br />Teknisi Akuntansi</td>
...
<br />
  ...
  <tr>
    ...
    <td style="width: 50%;font-size: 50px;font-weight: bold;border-bottom-color: beige 4px;"><hr class="hr_cover"/>REAL ASESMEN</td>
    
  </tr>
  <tr>
    <td style="width: 50%;"></td>
    <td style="width: 50%;font-size: 20px;font-weight: bold;border-bottom-color: beige 4px;"><hr class="hr_cover"/>SKEMA SERTIFIKASI :<br /><?=$data_asesi->skema?></td>
  ...
  <tr>
    <td style="width: 50%;"></td>
    <td style="width: 50%;font-size: 50px;font-weight: bold;border-bottom-color: beige 4px;"><hr class="hr_cover"/>2016<hr class="hr_cover"/></td>
    
  </tr>
  <tr>
    <td colspan="2" style="text-align: center;font-size: 40px;height: 150px;font-style: italic;vertical-align: bottom;"><?=$data_asesi->nama_lengkap?><hr /></td>
  </tr>
  <tr>
    <td colspan="2" style="text-align: center;font-size: 30px;font-style: italic;"><?=$data_asesi->no_uji_kompetensi?></td>
  </tr>
 ...
 <tr nobr="true">
  ...
  <tr nobr="true">
    <td style="width:100%;border: 1px solid;text-align: justify;" colspan="4" >
        PERNYATAAN : Dalam rangka mengikuti kegiatan uji kompetensi yang di adakan oleh Lembaga Sertifikasi Profesi Teknisi Akuntansi, dengan ini
...
?>
 ...
 <tr nobr="true">
	...
	<td colspan="2"> <strong>Pemohon :</strong> </td> 
 </tr>
...
<page backtop="10mm" backbottom="10mm" backleft="20mm" backright="20mm" ">
    <page_header>
        <table style="width: 100%; border: 0px;">
            <tr>
                <td style="text-align: left;    width: 5%"><img src="<?php echo base_url().'assets/img/logo48.png';?>" /></td>
                <td style="text-align: left;    width: 54%;font-weight: lighter;">Lembaga Sertifikasi Profesi Teknisi Akuntansi</td>
