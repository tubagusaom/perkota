...
<br />
  ...
  <tr>
    <td colspan="2" style="text-align: center;"><qrcode value="<?php echo $qr_asesi; ?>" ec="Q" style="width: 40mm;"></qrcode></td>
  </tr>
...
<table border="1"  cellpadding="2" style="border-collapse: collapse;width: 100%;font-size: 10px;">
    ...
    <tr>
        ...
        <td style="text-align: center"><?=$value->v='1'?'Y':''?> </td>
        <td style="text-align: center"> <?=$value->a='1'?'Y':''?> </td>
        <td style="text-align: center"> <?=$value->t='1'?'Y':''?> </td>
        <td style="text-align: center"> <?=$value->m='1'?'Y':''?> </td>
    </tr>
    <?php
    }
    ?>
...
<br />
 <table style="width:100%" border="1" cellpadding="3" cellspacing="0" style="border-collapse: collapse;">
 <tr nobr="true">
  <td rowspan="3" style="width: 50%;"> <strong>Rekomendasi Asesor</strong> <br/><?=$data_asesi->pra_asesmen_description?> </td>
  <td colspan="2" style="width: 50%;"> <strong>Pemohon :</strong> </td> 
 </tr>
