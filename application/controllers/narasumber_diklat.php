...
class Narasumber_diklat extends MY_Controller {
    ...
    function index() {
        if ($_SERVER['REQUEST_METHOD'] == 'GET') {
            ...
            $grid = $this->grid->set_properties(array('model' => 'narasumber_diklat_model', 'controller' => 'narasumber_diklat', 'options' => array('id' => 'narasumber_diklat','pagination','rownumber')))->load_model()->set_grid();
