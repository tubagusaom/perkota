...
Class Album_Galeri_Model extends MY_Model {
    ...
    function get_album()
    {
        $this->db->select('a.id_kategori, a.nama_album, a.keterangan, b.kategori, a.id');
        $this->db->from('t_album a');
        $this->db->join('tbl007_artikel_kategori b','a.id_kategori = b.id');
