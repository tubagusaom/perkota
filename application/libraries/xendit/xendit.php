<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    class Xendit {
        ...
        function createVirtualAccount ($external_id, $bank_code, $name, $virtual_account_number = null) {

          // var_dump($virtual_account_number); die();
            ...
            $end_point = $this->server_domain.'/VirtualAccounts';
        ...
        function checkCallbackVirtualAccount ($id,$external_id, $bank_code, $name, $virtual_account_number = null) {
          ...
          $data['bank_code'] = $bank_code;
          $data['name'] = $name;
          $data['account_number'] = $virtual_account_number;
